...
while running:
    ...
    text = font.render('Distância: ' + str(distancia), True, white)
    text_rect = text.get_rect()
    text_rect.center = (55, 380)
    screen.blit(text, text_rect)
    
    text2 = font.render('Distância2: ' + str(distancia2), True, white)
